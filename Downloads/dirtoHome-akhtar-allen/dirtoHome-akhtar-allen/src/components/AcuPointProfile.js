...
const Acupoints = (incomingData) => {
    ...
    return (
        <div>
            ...
            >
                <ItemList listName="Physical Location" value={props.physicalLocation}/>
                <ItemList listName="Five Element" value={props.fiveElement} />
                <ItemList listName="Horary Cycle" value={props.horarycycle} />
                <ItemList listName="Functionality"value={props.functionality}/>
...
export default React.memo(Acupoints);
