...
import NumbersSayEverything from "../../components/other/NumbersSayEverything";
import InfoBox3 from "../../components/other/infoboxes/InfoBox3";
// import PlaceGrid from "../../components/places/PlaceGrid";
import CompanyCardList from "../../components/places/CompanyCardList";
        ...
        <main className="home-1">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-3">
                            <div className="btn-box">
                                <Button
                                    text={
                                        sectiondata.calltoactions.cta1.btntext
                                    }
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-8 mx-auto mt-4">
                            <Testimonial
                                slideitems={sectiondata.testimonialdata.sliders}
                            />
                        </div>
                    </div>
                </div>
            ...
            <section className="blog-area padding-top-100px padding-bottom-80px">
                <div className="container">
                    ...
                    {/* <LatestBlog
                        latestarticles={sectiondata.latestarticles.items}
                    /> */}
                </div>
            </section>
