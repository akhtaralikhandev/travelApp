    ...
    <main className="home-5">
            ...
            <div className="col-lg-12">
              ...
              <div className="hero-catagory after-none text-center mt-4">
                <PopularCategoriesTwo
                  catitems={sectiondata.categories.popularcategories.lists}
      ...
      <section className="cat-area padding-top-100px padding-bottom-90px">
        <div className="container">
          <div className="row section-title-width text-center">
            <SectionsHeading
              title={sectiondata.categories.browsecategories2.sectitle}
          ...
          <BrowseCategoriesTwo
            catitems={sectiondata.categories.browsecategories2.categories}
          />
        </div>
      </section>
      ...
      <section className="hiw-area text-center padding-top-100px padding-bottom-80px">
        <div className="container">
          <div className="row section-title-width text-center">
            <SectionsHeading
              title={sectiondata.howitworks.hiw6.sectitle}
              titleClass=" before-none pt-0"
              desc={sectiondata.howitworks.hiw6.seccontent}
            />
          </div>

          <div className="row padding-top-100px">
            <InfoBoxOne
              infoitems={sectiondata.howitworks.hiw6.items}
              cardcol={3}
            />
          </div>
        </div>
        ...
        <div className="container">
          <div className="row section-title-width">
            <SectionsHeading
              ...
              titleClass=" text-white before-none pt-0"
      ...
      <section className="blog-area padding-top-100px padding-bottom-80px">
        <div className="container">
          <div className="row section-title-width text-center">
            <SectionsHeading
              title={sectiondata.latestarticles.sectitle}
              titleClass=" before-none pt-0"
              desc={sectiondata.latestarticles.seccontent}
            />
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-9 text-left">
              <SectionsHeading
                ...
                titleClass=" before-none pt-0 mb-3 text-white font-size-28"
            ...
            <div className="col-lg-3">
              <div className="btn-box">
                <Button
                  ...
                  className=" bg-white color-text-2"
